...
function GetUpcomingEvents() {
    ...
    $.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPEvent')/items?$select=ID,AttachmentFiles,Attachments,Pillar,Title,EventDescription,AverageRating,EventDate,EventStartTime,EventEndTime,VideoURL&$expand=AttachmentFiles&$filter=Pillar eq 'Wellbeing' and EventDate ge '"+today+"'&$orderby=Created desc",
        method: "GET",
        headers:
           {
