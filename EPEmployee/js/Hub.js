...
function GetHubHeadTiles() {
    ...
    $.ajax({
        ...
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPBanner')/items?&$top=1&$select=ID,Pillar,Title,Attachments,TargetURL,BannerDescription&$expand=AttachmentFiles&$filter=(Pillar eq 'Uncover')&$orderby=Created desc",
