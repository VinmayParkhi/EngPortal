 ...
 $("#saveNowsurvey").click(function() {formSaveSaveNow()}); 
 ...
 //var EventStartDateTime = moment(EventDate+ ' ' +EventStartTime).format('YYYY/MM/DD HH:mm');
	...
	createNewItemWithAttachmentsSaveNow("EPSurvey", data).then( 
	function() { 
