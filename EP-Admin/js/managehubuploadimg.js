 ...
 createNewItemWithAttachments("TestList", data).then( 
 function
 () { 
...
function createList(listName1) {
var siteUrl = _spPageContextInfo.webAbsoluteUrl+ "/_api/web/lists/GetByTitle('Thought_List')/Items";
var data = {
__metadata: { 'type': 'SP.Data.Thought_x005f_ListListItem' },
ThoughText: $("input[title='thought']").val(),
Title: listName1
}
$.ajax({
url: siteUrl,
