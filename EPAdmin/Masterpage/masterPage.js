...
function userdetails(){
	var requesturl = "https://infornt.sharepoint.com/sites/RNTENG/_api/SP.UserProfiles.PeopleManager/GetMyProperties";
	$.ajax({      
		url: requesturl,      
		type: "GET",      
		headers: {      
...
function GetPastEvents1() {
    ...
    ({
        ...
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPMoodMeter')/items?$select=ID,Mood,Created&$orderby=Created desc",
        method: "GET",
        headers:
           {
               "Accept": "application/json;odata=verbose"
