  ...
  var siteurl = "https://infornt.sharepoint.com/sites/RNTENG";
   ...
   var toDateCh;
    ...
    $("#maxValue").datepicker({
      ...
      onSelect: function (dateText) {
                var date2 = $(this).val();
                toDateCh = moment(date2).format('DD/MM/YYYY')
                //log(fromDate)
...
function loadListItems(min,max) {
	...
	var url = _spPageContextInfo.webAbsoluteUrl + "/_api/web/lists/getbytitle('EPEvent')/items?&$top=5000&$select=*,Author/Title&$expand=Author&$orderby = EventDate desc";
	//var url = siteurl+ "/_api/web/lists/getbytitle('TestList')/items?&$select=*";
	console.log(url);        
