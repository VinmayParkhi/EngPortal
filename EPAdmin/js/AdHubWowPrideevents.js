...
function GetUpcomingEvents() {
   ...
   $.ajax({
       url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPEvent')/items?$select=ID,Attachments,Pillar,Title,EventDescription,AverageRating,EventDate,EventStartTime,VideoURL,Response1,Response2,Response3&$expand=AttachmentFiles&$filter=Pillar eq 'Wow and pride' and EventDate ge '"+today+"'&$orderby=Created desc",
       method: "GET",
       headers:
          {
