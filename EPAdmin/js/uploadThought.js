...
function GetThoughtDate() {
    ...
    $.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPThought')/items?$select=Created,Thought&$orderby=Created desc",
        method: "GET",
        headers:
           {
        ...
        success: function (data, status, xhr) {
            var dataresults = data.d.results;
               ...
               ThoughText = data.d.results[0].Thought;
