        ...
        success: function (data, status, xhr) {
            ...
            if(today >= ReminderDate && data.d.results[i].ReminderStatus == "Unread"){
            	...
            	//$(".MainTool").show().delay(7000).fadeOut();
           		  $("#notificationCard").append('<div id="notificationDivMain" onclick="UpdateNotification(this.className);" class="'+EventID+'" style=""> <div class="notification" style="padding: 10px; background: #F2ECD5; margin: 5px; border-radius: 10px;"> <div class="titleDiv d-flex align-items-center justify-content-between"><span style="height:auto;display:flex;align-items:self-start;"><img style="margin-right: 5px;width: 13px;height:auto;"  src="../../SiteAssets/ENGEmployee/images/Icon material-access-alarm.svg">'+
											   ...
											   '<img style="width:12px;height:auto;margin-right: 5px;" src="../../SiteAssets/ENGEmployee/images/Icon ionic-md-calendar.svg">'+EventDate+'</span><span style="height:auto;display:flex; align-items:flex-start;"><img style="width:12px;height:auto;margin-right: 5px;" src="../../SiteAssets/ENGEmployee/images/Icon ionic-md-time.svg">'+EventEndTime+'</span>	'+
            ...
            for (var i = 0; i <dataresults.length; i++) {
               ...
               if(ReminderDate < today && data.d.results[i].ReminderStatus == "Unread"){
                  ...
                  $(".notificationCard").append('<div id="notificationDivMain" onclick="UpdateNotification(this.className);" class="'+EventID+'"> <div class="notification" style="padding: 10px; background: #F2ECD5; margin: 5px; border-radius: 10px;"> <div class="titleDiv d-flex"> <div class="subdiv"><div class="d-flex align-items-center"> <img style="margin-right:2px;width:15px" src="../../SiteAssets/ENGEmployee/images/Icon material-access-alarm.svg">'+
											   ...
											   '<img style="width:15px;margin-right:2px" src="../../SiteAssets/ENGEmployee/images/Icon ionic-md-calendar.svg">'+EventDate+'</span><span style="display:flex; align-items:center;height:auto;"><img style="height:auto;width:15px;margin-right:2px" src="../../SiteAssets/ENGEmployee/images/Icon ionic-md-time.svg">'+EventEndTime+'</span></div> </div> </div>');
