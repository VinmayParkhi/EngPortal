            ...
            for (var i = 0; i < 3; i++) {
               ...
               VideoURLs = data.d.results[i].VideoURL;
                 ...
                 $(".upcomingEventsWr").append('<div class="col-12 col-md-6 col-lg-4 card upcomingEventsCard"> <div class="upcomingeventsImg"  style=" display: flex; flex-direction: column; justify-content: center; align-items: start; "> <div class="userImg1"'+
												...
												'<img src="../../SiteAssets/ENGEmployee/images/Transparent_share_02.svg" alt="Share"></a></div><div class="heart">'+
												'<a href="#" onclick="FavEvents(this.id,this.className,this.title,this.name,this.hreflang,event);" hreflang="'+EventId+'" title="'+EventDescription+'"  id="'+EventTitle+'" name="'+imageURL+'" class="'+pillar+'"><img class="upHeart" src="../../SiteAssets/ENGEmployee/images/Group 3218.svg" alt="Heart"></a>'+
												...
												'<a href="#"> <img src="../../SiteAssets/ENGEmployee/images/Icon feather-calendar.svg" alt="Mail"><label>'+EventDates+'</label></a></div>'+
												'<div class="upcomingeventsClock"><a href="#"><img src="../../SiteAssets/ENGEmployee/images/Icon feather-clock.svg" alt="Message"><label>'+EventStartTime+'</label></a> </div> </div> '+
...
function GetPastEvents() {
 	var today= moment().format('YYYY-MM-DDTHH:mm:SS');    
 	$.ajax({
        url: _spPageContextInfo.webAbsoluteUrl + "/_api/lists/getByTitle('EPEvent')/items?$select=ID,Attachments,Pillar,Title,EventDescription,EventDate,EventStartTime,VideoURL&$expand=AttachmentFiles&$filter=(Pillar eq 'Life') and (EventStatus eq 'Completed') and (EventEndTime le '"+today+"') and (VideoURL ne null)&$orderby=EventDate desc",
        method: "GET",
        headers:
           {
               "Accept": "application/json;odata=verbose"
            ...
            for (var i = 0; i < 3; i++) {
               ...
               VideoURLs = data.d.results[i].VideoURL;
 				...
 				$(".pastEvntsWr1").append('<div class="col-12 col-md-6 col-lg-4 card pastevntsCard"><div class="pstvideoImg1" style="height: auto;background-image:linear-gradient(180deg, #00000000 0%, #0D0D0DE8 74%, #121112 100%), url('+b+');background-repeat: no-repeat;background-position: center top;background-size: 100% 100%;display: flex; flex-direction: column;justify-content: center;align-items: center;">'+ 
                            ...
                            '<img src="../../SiteAssets/ENGEmployee/images/Icon ionic-ios-star.svg" alt="Star"> <label id="popuprate"> <h5 id="popuprate-h5">0(0)</h5></label>'+
...
console.log("sankedfaf")
	...
	// evetit = event.target.parentElement.nextElementSibling.nextElementSibling.firstElementChild.nextElementSibling.firstElementChild.firstElementChild.firstElementChild.innerText;
	var evetit = event.target.parentElement.nextElementSibling.firstElementChild.nextElementSibling.innerText;
              ...
              var id = Number(results[j].EventID);
               ...
               for(var i=0;i<a.length;i++){
                  ...
                  if(bNum === id){
                     ...
                     c.setAttribute("src", "https://amdocs.sharepoint.com/sites/EP/SiteAssets/EngEmployee/images/Group 3212 (1).svg")
                  } 
              }
             }
